...
- 기대효과 
 - 고려대학교 학생들을 대상으로 현재 교내 동아리 만족도에 대한 설문조사 수행 (N=50)
  - 해당 플랫폼이 필요하다 -> 51%, 매우필요하다 -> 26.5%
  - 실제로 해당 플랫폼을 사용할 것이다 -> 49% , 매우 그렇다 -> 38%

- 기대효과
 - 해당 플랫폼이 수강 신청 전에 과목에 대한 정보를 얻는 사이트인 KLUE처럼, 동아리 선택을 위해 고려대학교 학생들에게 널리 쓰이는 유용한 사이트로 발전할 가능성이 있는가 -> 79.6% 그렇다고 응답
